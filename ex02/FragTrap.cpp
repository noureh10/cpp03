...
/*   Updated: 2024/08/23 17:37:16 by nechaara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(void) {
	outputMessage("Passing trough default constructor of FlagTrap");
	FragTrap("Victor");
}

FragTrap::FragTrap(std::string name) {
	outputMessage("Passing trough the constructor of FlagTrap");
	this->setName(name);
